...
| **Final (Test)** | Лучшая конфигурация | X.XM | - | **XX.X%** |

**Анализ:**
- Какая конфигурация показала лучший результат?
- Есть ли признаки переобучения (большая разница между train и val)?
- Как изменялась производительность на каждом этапе?
- Какие выводы можно сделать о влиянии каждого компонента (каналы, глубина, активации)?